			...
			bookmarks = [
				...
				bookmarks = [
					...
					bookmarks = [
					    ...
					    { name = "Latex Symbols"; url = "https://latexai.app/symbols"; }
					];
				    }
				    {
					name = "Programming";
				...
				name = "Math";
				bookmarks = [
				    { name = "Geometric Analysis Gallery"; url = "https://mbschulz.github.io/"; }
				    { name = "Penrose diagrams Penrose"; url = "https://anilzen.github.io/post/2022/drawing-penrose-diagrams/#:~:text=The%20coordinates%20of%20the%20Penrose,and%20plot%20them%20with%20TikZ"; }
				    { name = "Professor Merry"; url = "https://www2.math.ethz.ch/will-merry/index.html"; }
				    { name = "Statistics Calculator"; url = "https://www.socscistatistics.com/tests/"; }
				    { name = "Mathematics Stack Exchange"; url = "https://math.stackexchange.com/users/1160260/gandalf-thegray"; }
				];
			    }
			    {
				name = "Music";
				bookmarks = [
				    { name = "Lilypond Sheet Music Collection"; url = "https://www.mutopiaproject.org/"; }
				    { name = "Latin American Cello"; url = "https://www.cellobello.org/latin-american-cello-works/"; }
				    { name = "8notes"; url = "https://www.8notes.com/Default.asp"; }
				    { name = "Early Church Songs"; url = "https://westpark-baptist.com/ancient-christian-hymns/"; }
				    { name = "ATLA Orchestra"; url = "https://flat.io/score/6137c6843d0ddb0015c0a947-avatar-the-last-airbender"; }
				    { name = "ATLA Solo Cello"; url = "https://musescore.com/user/28485981/scores/6617766"; }
				];
			    }
			    {
				name = "Entertainment";
				...
				name = "Meteo";
				bookmarks = [
				    { name = "Temperature"; url = "https://www.meteoswiss.admin.ch/services-and-publications/applications/temperature.html"; }
				    { name = "Percipitation"; url = "https://www.meteoswiss.admin.ch/home.html?tab=rain"; }
				    { name = "Forecast"; url = "https://www.meteoswiss.admin.ch/"; }
				];
			    }
			    {
				name = "Admin";
				...
				name = "Work";
				bookmarks = [
				    { name = "LinkedIn"; url = "https://www.linkedin.com/in/julianbuerge/"; }
				    { name = "ETH Spinoffs"; url = "https://entrepreneurship.ethz.ch/startup-stories/explore-startup-portraits-and-success-stories/uebersicht-eth-spin-offs.html"; }
				    { name = "Web Lernen"; url = "https://web-lernen.com/"; }
				    { name = "Outlier"; url = "https://app.outlier.ai/expert"; }
				];
			    }
			];
		    }
